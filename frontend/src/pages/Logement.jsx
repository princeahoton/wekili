      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-2 py-1 z-40">
        <div className="flex justify-around max-w-lg mx-auto">
          {[
            ...
            <button key={item.path} onClick={() => navigate(item.path, { replace: true })} className={`flex flex-col items-center gap-0.5 px-3 py-2 rounded-xl transition-colors ${location.pathname === item.path ? 'text-[#1a3a6b]' : 'text-gray-400 hover:text-gray-600'}`}>
              {item.icon}
